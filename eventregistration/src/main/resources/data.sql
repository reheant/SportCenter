INSERT INTO account (id, email, first_name, last_name, password) VALUES
    (1, 'john.doe@example.com', 'John', 'Doe', 'P@ssw0rd'),                    -- 1
    (2, 'jane.smith@example.com', 'Jane', 'Smith', 'Secure123'),               -- 2
    (3, 'michael.johnson@example.com', 'Michael', 'Johnson', 'Passw0rd!'),     -- 3
    (4, 'emily.wilson@example.com', 'Emily', 'Wilson', 'StrongP@ss'),          -- 4
    (5, 'david.brown@example.com', 'David', 'Brown', 'Brownie2024'),           -- 5
    (6, 'admin@example.com', 'Jesus', 'Christ', 'strongpassword123');          -- 6
